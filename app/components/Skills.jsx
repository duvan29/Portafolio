    ...
    <div className="w-full pt-5 flex justify-between items-stretc">
      <div className="w-[49%] bg-gris-50 p-4 rounded-lg">
        ...
        <div className='w-[100px] justify-center items-center flex flex-col'>
            ...
            <h3 className="text-center my-3">Next</h3>
        </div>
        <div className='w-[100px] justify-center items-center flex flex-col'>
            <button className="bg-gris text-white p-4 rounded-full flex items-center justify-center">
        ...
        <div className='w-[100px] justify-center items-center flex flex-col'>
            ...
            <h3 className="text-center my-3">Redux</h3>
        </div>
        <div className='w-[100px] justify-center items-center flex flex-col'>
            <button className="bg-gris text-white p-4 rounded-full flex items-center justify-center">
            <svg width="800px" height="800px" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg" className='w-8 h-8'>
            ...
            <h3 className="text-center my-3">Tailwindcss</h3>
        </div>
        ...
        <div className='w-[100px] justify-center items-center flex flex-col'>
            ...
            <h3 className="text-center my-3">CSS</h3>
        </div>
        <div className='w-[100px] justify-center items-center flex flex-col'>
            <button className="bg-gris text-white p-4 rounded-full flex items-center justify-center">
                <svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 384 512" className='w-8 h-8'><path d="M0 32l34.9 395.8L191.5 480l157.6-52.2L384 32H0zm308.2 127.9H124.4l4.1 49.4h175.6l-13.6 148.4-97.9 27v.3h-1.1l-98.7-27.3-6-75.8h47.7L138 320l53.5 14.5 53.7-14.5 6-62.2H84.3L71.5 112.2h241.1l-4.4 47.7z"/></svg>
            </button>
            <h3 className="text-center my-3">HTML</h3>
        </div>
        </div>
