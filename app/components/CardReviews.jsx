...
export default function CardReviews({ review }) {
  ...
  return (
    <div className='w-full'>
      ...
      <div className="m-3 p-4 min-w-[80%]">
        <div className="mb-4">
          <p className="overflow-hidden text-[15px] ">{review.reviewText}</p>
        </div>
        ...
        <div className="flex items-center mb-2 mt-4">
          <img
            src={review.Imagen}
            alt={`Imagen de ${review.userName}`}
            className="w-20 h-20 rounded-full mr-5"
            width={245}
            height={154}
          />
          <div className='flex flex-col'>
            <h3 className='text-[18px]'>{review.userName}</h3>
            <p className='text-[15px]'>{review.userRole}</p>
          </div>
        </div>
      </div>
    </div>
