...
export default function Proyects() {
    ...
    const i = useTranslations("Certificate");
    return (
        <>
            <div className='bg-gris-50 p-4 rounded-lg flex justify-evenly items-center'>
                ...
                <h3 className="text-center w-[100px] my-3">{t("proyects")}</h3>
            </div>
            <div className='bg-gris-50 p-4 rounded-lg mt-2.5 flex justify-evenly items-center'>
                <button className="bg-gris text-white p-4 rounded-full flex items-center justify-center">
